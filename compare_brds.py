...
if st.button("Upload Documents"):
    if brd_v1 and brd_v2:
        ...
        st.warning("Please upload both BRD versions before proceeding.")
...
if st.button("Ingest Documents"):
    if brd_v1 and brd_v2:
        ...
        st.warning("Please upload both BRD versions before ingestion.")
...
if st.button("Compare Documents"):
    if brd_v1 and brd_v2:
        ...
        if content_v1 and content_v2:
            ...
            st.header("Amendments from Previous BRD:")
            st.code('\n'.join(diff))
        else:
            st.warning("Could not retrieve content for comparison.")
    else:
        st.warning("Please upload both BRD versions before comparing.")
...
if st.button("Query Amendments"):
    if brd_v1 and brd_v2:
        ...
        st.header("BRD Version 1 Response:")
        st.write(response_v1)

        st.header("BRD Version 2 Response:")
        st.write(response_v2)
    else:
        st.warning("Please upload both BRD versions before querying.")
